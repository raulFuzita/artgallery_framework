...
function loadContent(){
    ...
    Controller = "../App/Controller/User/Accounts/LoadAccounts.Controller.php";
...
function drawPagination(currentPage){
    // Load the Pagination
    Controller = "../App/Controller/User/Accounts/LoadPagination.Controller.php?page="+currentPage;
...
function onclickDetected(target){
    ...
    if(targetClass == "page"){
        ...
        // Load all content from a database table
        Controller = "../App/Controller/User/Accounts/PageAccounts.Controller.php?page="+number;
        displayTo = "ajax-content";
        ajaxRequest(displayTo, Controller);
...
function searchContent(text){
    ...
    if(text.length == 0){
        ...
        // Load all content from a database table
        Controller = "../App/Controller/User/Accounts/SearchAccounts.Controller.php?search="+text;
        displayTo = "ajax-content";
        ajaxRequest(displayTo, Controller);
    }
}
