...
function loadContent(){
    ...
    Controller = "../App/Controller/Artist/Artists/LoadArtists.Controller.php";
...
function drawPagination(currentPage){
    // Load the Pagination
    Controller = "../App/Controller/Artist/Artists/LoadPagination.Controller.php?page="+currentPage;
...
function onclickDetected(target){
    ...
    if(targetClass == "page"){
        ...
        // Load all content from a database table
        Controller = "../App/Controller/Artist/Artists/PageArtists.Controller.php?page="+number;
        displayTo = "ajax-content";
        ajaxRequest(displayTo, Controller);
...
function searchContent(text){
    ...
    if(text.length == 0){
        ...
        // Load all content from a database table
        Controller = "../App/Controller/Artist/Artists/SearchArtists.Controller.php?search="+text;
        displayTo = "ajax-content";
        ajaxRequest(displayTo, Controller);
    }
}
